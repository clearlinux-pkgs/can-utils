...
Version  : 2021.06.0
Release  : 5
URL      : https://github.com/linux-can/can-utils/archive/v2021.06.0/can-utils-2021.06.0.tar.gz
Source0  : https://github.com/linux-can/can-utils/archive/v2021.06.0/can-utils-2021.06.0.tar.gz
...
%prep
%setup -q -n can-utils-2021.06.0
cd %{_builddir}/can-utils-2021.06.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624545912
...
cp %{_builddir}/can-utils-2021.06.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/can-utils/9a2473b1af68a99d91b786625fcf075c2b24c35f
%make_install
