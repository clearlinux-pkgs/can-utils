...
Version  : 2021.08.0
Release  : 6
URL      : https://github.com/linux-can/can-utils/archive/v2021.08.0/can-utils-2021.08.0.tar.gz
Source0  : https://github.com/linux-can/can-utils/archive/v2021.08.0/can-utils-2021.08.0.tar.gz
...
%prep
%setup -q -n can-utils-2021.08.0
cd %{_builddir}/can-utils-2021.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629383844
...
cp %{_builddir}/can-utils-2021.08.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/can-utils/9a2473b1af68a99d91b786625fcf075c2b24c35f
%make_install
